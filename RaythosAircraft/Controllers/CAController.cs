    ...
    public class CAController : Controller
    {
        ...
        private void FetchData()
        {
            ...
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = "SELECT TOP (1000) [OrderId]      ,[Name]      ,[Email]      ,[Address]      ,[ContactNo]      ,[AgreementStatus]      ,[PurchaseDate]      ,[DeliveryDate]      ,[Status]      ,[Total]      ,[ProductCode]      ,[ItemCode]  FROM [Raythos_Aerospace].[dbo].[Order] WHERE [Status] = 'Placed'";
        ...
        private void FetchDataProduction()
        {
            ...
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = "SELECT TOP (1000) [OrderId]      ,[Name]      ,[Email]      ,[Address]      ,[ContactNo]      ,[AgreementStatus]      ,[PurchaseDate]      ,[DeliveryDate]      ,[Status]      ,[Total]      ,[ProductCode]      ,[ItemCode]  FROM [Raythos_Aerospace].[dbo].[Order] WHERE [Status] = 'Production'";
                dr = com.ExecuteReader();
                while (dr.Read())
                {
                    OrderLists.Add(new Order()
        ...
        private void FetchDataDelivery()
        {
            ...
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = "SELECT TOP (1000) [OrderId]      ,[Name]      ,[Email]      ,[Address]      ,[ContactNo]      ,[AgreementStatus]      ,[PurchaseDate]      ,[DeliveryDate]      ,[Status]      ,[Total]      ,[ProductCode]      ,[ItemCode]  FROM [Raythos_Aerospace].[dbo].[Order]  WHERE [Status] = 'Delivery'";
                dr = com.ExecuteReader();
                while (dr.Read())
                {
                    OrderLists.Add(new Order()
        ...
        private void FetchDataCompleted()
        {
            ...
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = "SELECT TOP (1000) [OrderId]      ,[Name]      ,[Email]      ,[Address]      ,[ContactNo]      ,[AgreementStatus]      ,[PurchaseDate]      ,[DeliveryDate]     ,[Status]      ,[Total]      ,[ProductCode]      ,[ItemCode]  FROM [Raythos_Aerospace].[dbo].[Order] WHERE [Status] = 'Completed'";
                dr = com.ExecuteReader();
                while (dr.Read())
                {
                    OrderLists.Add(new Order()
        ...
        public IActionResult UpdateToProduction(string orderId)
        {
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = $"UPDATE [Raythos_Aerospace].[dbo].[Order] SET [Status] = 'Production' WHERE [OrderId] = '{orderId}'";
                com.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateToDelivery(string orderId)
        {
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = $"UPDATE [Raythos_Aerospace].[dbo].[Order] SET [Status] = 'Delivery' WHERE [OrderId] = '{orderId}'";
                com.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateToCompleted(string orderId)
        {
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = $"UPDATE [Raythos_Aerospace].[dbo].[Order] SET [Status] = 'Completed' WHERE [OrderId] = '{orderId}'";
                com.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
