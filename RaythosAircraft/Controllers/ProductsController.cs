...
namespace RaythosAircraft.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ConfirmDetails(string ProductName, double Total, DateTime PurchaseDate, string DeliveryDate)
        {
        ...
        // This action updates an existing order with additional customer details

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<JsonResult> EnterDetails(int orderId, string name, string address, string number, string email)
        {
        ...
        public async Task<IActionResult> PurchaseHistory_Shipping(int id)
        {
